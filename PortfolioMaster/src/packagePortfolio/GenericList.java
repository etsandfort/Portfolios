...
/**
 * GenericList<T> is the class that is the mould for the team's sorted list ADT.
 * RAIK 184H
...
public class GenericList<T> implements Iterable<T>{
	...
	/**
	 * Constructor for the GenericList<T> class. Constructs GenericList objects.
	 * @param c, the comparator of choice
	 */
	@SuppressWarnings("unchecked")
	public GenericList(Comparator<T> c) {
